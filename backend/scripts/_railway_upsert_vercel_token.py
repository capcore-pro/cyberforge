"""Ajoute VERCEL_TOKEN sur Railway."""
...
def _vercel_token() -> str:
    ...
    raise SystemExit("VERCEL_TOKEN introuvable dans backend/.env")
...
def main() -> None:
    ...
    print("variableUpsert VERCEL_TOKEN:", data["variableUpsert"])
