...
Réponds UNIQUEMENT avec un objet JSON valide (pas de markdown), structure exacte :
{
  ...
  "home": {
    "hero": { "title", "subtitle", "ctaPrimary": {"label","href"}, "ctaSecondary": {"label","href"}, "image": {"url","alt","photographer","photographerUrl"} },
    "servicesPreview": [ 3 objets { "title", "description", "href": "/services#id", "image": {...} } ],
    "testimonials": [ 3 objets { "quote", "author", "role", "rating": 5 } ],
    "ctaBand": { "title", "text", "buttonLabel", "buttonHref": "/contact" }
  },
  "servicesPage": {
    "intro": { "title", "description" },
    "sections": [ 3 objets { "id": "slug-kebab", "title", "description", "bullets": ["..."], "image": {...} } ]
  },
  "contactPage": {
    "headline", "subtext",
...
Règles images : urls Unsplash réalistes (images.unsplash.com/photo-...?auto=format&fit=crop&w=1200&q=80).
